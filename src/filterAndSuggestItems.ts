...
export const defaultStopWords = [
    'and', 'to', '.', 'the', ',', 'of', 'in', 'for', '&', 'a', 'an', 'with', 'on',
    'at', 'from', 'as', 'by', 'or', 'but', 'into', 'is', 'are', 'was', 'were', 'be',
    'being', 'been', 'have', 'has', 'had', 'having', 'do', 'does', 'did', 'doing',
    'will', 'would', 'should', 'can', 'could', 'may', 'might', 'must', 'ought', 'shall',
    'should', 'there', 'their', 'they', 'them', 'these', 'those', 'this', 'that', 'then',
    'than', 'thus', 'so', 'such', 'if', 'else', 'not', 'no', 'yes', 'i', 'you', 'he', 
    'she', 'it', 'we', 'me', 'him', 'her', 'us', 'my', 'your', 'his', 'its', 'our',
    'mine', 'yours', 'hers', 'ours', 'theirs', 'who', 'whom', 'which', 'what', 'when',
    'where', 'why', 'how', 'up', 'about', 'into', 'with', 'over', 'before', 'after',
    'between', 'among', 'through', 'during', 'above', 'below', 'out', 'off', 'down', 
    'under', 'again', 'further', 'once', 'here', 'all', 'any', 'both', 'each', 'few',
    'more', 'most', 'other', 'some', 'such', 'both', 'each'
  ];
   ...
   */
  export function filterAndSuggestItems<ItemType, IdType extends string | number = string>(
    searchText: string = '',
    ...
    const excludedIdsSet = new Set(Array.isArray(excludedIds) ? excludedIds.map(String) : [String(excludedIds)]);
    ...
    for (const item of dataItems) {
      ...
      const isMatch = fieldsToSearch.some((field) => {
        ...
        const itemWords = itemFieldValue.toLowerCase().split(' ').filter((word) => !stopWords.includes(word));
